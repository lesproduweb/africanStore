"""
Django settings for aStore project.
...
SECRET_KEY = 'django-insecure-n4#&+9$wzxw@q=xo74105(k=$i2oo(g@)jw=qi5%gd^ahn=qca'
...
WSGI_APPLICATION = 'aStore.wsgi.application'
